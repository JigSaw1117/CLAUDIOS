...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .brand-title {
      font-weight: 800; font-size: 1.1rem; color: #ffffff; line-height: 1.2;
    }
    .brand-sub {
    ...
    /* HERO CON LA FOTO REAL DE FONDO Y OVERLAY */
    .hero {
      background: linear-gradient(135deg, rgba(10, 37, 64, 0.85) 0%, rgba(13, 60, 108, 0.82) 100%), url('fondo.jpg') center/cover no-repeat;
    ...
    .case-card:hover {
      transform: translateY(-4px); box-shadow: 0 10px 25px rgba(10,37,64,0.12);
    }
...
<body>
  ...
  <!-- NAVBAR CON LOGO REAL LOGO-UAC.JPG -->
